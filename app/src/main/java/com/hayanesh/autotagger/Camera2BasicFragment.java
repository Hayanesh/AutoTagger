...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String imageFileName = "AT_" + timeStamp + "_" + ".jpg";
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    main.putExtra("image",mFile.toString());
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.gallery:
            {
                //Toast.makeText(getActivity(), "Inside gallery", Toast.LENGTH_SHORT).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try{
            if(requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && data != null)
            {
                ...
                cursor.moveToFirst();
                //Toast.makeText(getActivity(), "Inside onResult", Toast.LENGTH_SHORT).show();
                ...
                Intent main = new Intent(getActivity(),MainActivity.class);
                main.putExtra("image",imgDecodableString);
                startActivity(main);
                //photo.setImageBitmap(BitmapFactory.decodeFile(imgDecodableString));
            }
            else
            {
                Toast.makeText(getActivity(), "You didn't pick an image", Toast.LENGTH_SHORT).show();
            }
    ...
    private void disableAutoFlash(CaptureRequest.Builder requestBuilder)
    {
        if (mFlashSupported) {
            requestBuilder.set(CaptureRequest.CONTROL_AE_MODE,
